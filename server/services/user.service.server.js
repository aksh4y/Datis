...
module.exports = function (app, userModel) {
    ...
    app.put("/api/user/:userId/deduction", addDeduction);
    app.delete("/api/user/:userId/deduction/remove", removeDeduction);
    ...
    function removeDeduction(req, res) {
        ...
        var deduction = req.body;
        userModel
            .removeDeduction(userId, deduction._id)
            .then(function (response) {
                res.sendStatus(200);
            }, function () {
                res.sendStatus(500);
